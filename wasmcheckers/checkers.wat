(module
    ...
    (func $isValidMove (param $fromX i32) (param $fromY i32) (param $toX i32) (param $toY i32) (result i32)
        ...
        (if (result i32)
            (block (result i32)
                (i32.and 
                    (call $validJumpDistace (local.get $fromY) (local.get $toY))
                    (i32.and
    ...
    (func $validJumpDistace (param $from i32) (param $to i32) (result i32)
        (local $d i32)
        (local.set $d 
            (if (result i32)
    ...
    (func $initBoard
        ...
        (call $setTurnOwner (i32.const 1)) ;; black first
    )
